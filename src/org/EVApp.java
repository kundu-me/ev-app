...
public class EVApp {
	...
	public void charging(String formatDtTm, String startDtTm, String stopDtTm) throws ParseException {
		...
		EVChargingTask evChargingTaskStart = new EVChargingTask(startTimer, stopTimer, true);
		EVChargingTask evChargingTaskStop = new EVChargingTask(startTimer, stopTimer, false);
